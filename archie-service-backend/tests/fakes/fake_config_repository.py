...
class FakeConfigRepository:
    ...
    configuration values without external dependencies. State is maintained
    across method calls within a test, and can be reset or reconfigured as needed.
    ...
    Example usage in tests:
        ...
        .. code-block:: python
            ...
            def test_feature_flag_disabled():
                '''Test that endpoints reject requests when feature is disabled.'''
    ...
    def get_bool(self, key: str, default: bool = False) -> bool:
        ...
        if isinstance(value, str):
            ...
            if lower_value in ('true', '1', 'yes', 'on'):
                ...
                raise ValueError(
                    f"Cannot convert string value '{value}' to boolean for key '{key}'"
                )
        ...
        raise ValueError(
            f"Cannot convert value of type {type(value).__name__} to boolean for key '{key}'"
        )
    ...
    def get_int(self, key: str, default: int = 0) -> int:
        ...
        if isinstance(value, str):
            try:
                ...
                raise ValueError(
                    f"Cannot convert string value '{value}' to integer for key '{key}'"
                )
        ...
        raise ValueError(
            f"Cannot convert value of type {type(value).__name__} to integer for key '{key}'"
        )
    ...
    def get_project_id(self) -> str:
        ...
        This is a convenience method specifically for retrieving the Google Cloud
        Platform project ID used in Secret Manager operations during testing.
        Returns a test project ID by default.
        ...
        """
        return self.get('GCP_PROJECT_ID', 'test-project-id')
    
    def set(self, key: str, value: Any) -> None:
        """
        Set configuration value for a key.
        
        Allows tests to dynamically modify configuration values to test different
        scenarios. This is useful for testing behavior under various configuration
        states without creating multiple repository instances.
    ...
    def enable_figma_integration(self) -> None:
        ...
        Convenience method to set FIGMA_INTEGRATION_ENABLED to True. This is
        commonly used in tests that need to verify feature behavior when enabled.
    ...
    def load_from_dict(self, config_dict: Dict[str, Any]) -> None:
        ...
        Bulk load multiple configuration values from a dictionary. This replaces
        the existing configuration entirely with the provided values.
        ...
        Example:
            ...
            .. code-block:: python
                ...
                def test_feature_flag_enforcement():
                    config = FakeConfigRepository.with_figma_disabled()
                    # Test that all Figma endpoints return feature disabled error
        """
        instance = cls()
    ...
    @classmethod
    def with_custom_config(cls, config_dict: Dict[str, Any]) -> 'FakeConfigRepository':
        """
        Create instance with custom configuration.
        
        Factory method that returns a new FakeConfigRepository instance initialized
        with the provided configuration dictionary. This is useful for tests that
        need specific configuration combinations.
    ...
    def keys(self) -> List[str]:
        ...
        dictionary. Useful for debugging tests and verifying configuration state.
