...
class AdminClient:
    ...
    def __init__(
        ...
        logger.info(f"AdminClient initialized with admin_url={self.admin_url}, timeout={self.timeout}")
            ...
            try:
                ...
                if 200 <= response.status_code < 300:
                    ...
                    try:
                        ...
                        logger.error(f"Failed to decode JSON response from admin service: {e}")
                        raise AdminServiceError(
                            f"Invalid JSON response from admin service",
                ...
                logger.error(
                    f"Admin service returned error: status={response.status_code}, "
                    f"message={error_message}, url={url}"
                )
                ...
                last_exception = e
                logger.warning(
                    f"Request to admin service timed out (attempt {attempt + 1}/{self.max_retries}): {url}"
                )
                ...
                last_exception = e
                logger.warning(
                    f"Connection to admin service failed (attempt {attempt + 1}/{self.max_retries}): {url}"
                )
                ...
                last_exception = e
                logger.warning(
                    f"Request to admin service failed (attempt {attempt + 1}/{self.max_retries}): {e}"
                )
    ...
    def create_figma_installation(
        ...
        """
        logger.info(f"Routing create_figma_installation request for user {user_context.get('user_id')}")
    ...
    def get_figma_installation(
        ...
        """
        logger.info(f"Routing get_figma_installation request for installation {installation_id}")
        return self._make_request(
            method='GET',
    ...
    def update_figma_pat(
        ...
        """
        logger.info(f"Routing update_figma_pat request for installation {installation_id}")
        return self._make_request(
            method='PUT',
    ...
    def delete_figma_installation(
        ...
        """
        logger.info(f"Routing delete_figma_installation request for installation {installation_id}")
        return self._make_request(
            method='DELETE',
            path=f'/v1/figma/installations/{installation_id}',
            user_context=user_context
    ...
    def share_figma_installation(
        ...
        """
        logger.info(
            f"Routing share_figma_installation request for installation {installation_id} "
    ...
    def revoke_figma_access(
        ...
        """
        logger.info(
            f"Routing revoke_figma_access request for installation {installation_id} "
            f"by user {user_context.get('user_id')}"
        )
        return self._make_request(
            method='DELETE',
    ...
    def validate_figma_frame(
        ...
        """
        logger.info(f"Routing validate_figma_frame request for user {user_context.get('user_id')}")
        return self._make_request(
            method='POST',
    ...
    def create_figma_attachments(
        ...
        """
        logger.info(
            f"Routing create_figma_attachments request for project {data.get('project_id')} "
            f"by user {user_context.get('user_id')}"
        )
        return self._make_request(
            method='POST',
    ...
    def list_figma_attachments(
        ...
        """
        logger.info(
            f"Routing list_figma_attachments request for project {query_params.get('project_id')}"
        )
        return self._make_request(
            method='GET',
            path='/v1/figma/attachments',
    ...
    def get_figma_attachment(
        ...
        """
        logger.info(f"Routing get_figma_attachment request for attachment {attachment_id}")
        return self._make_request(
            method='GET',
    ...
    def delete_figma_attachment(
        ...
        """
        logger.info(f"Routing delete_figma_attachment request for attachment {attachment_id}")
        return self._make_request(
            method='DELETE',
            path=f'/v1/figma/attachments/{attachment_id}',
            user_context=user_context
