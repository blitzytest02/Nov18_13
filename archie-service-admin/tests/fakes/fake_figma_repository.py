...
class FakeFigmaRepository(IFigmaRepository):
    ...
    def update_installation(
        ...
        **kwargs
        ...
        for key, value in kwargs.items():
            if key in installation and key not in ['id', 'created_at', 'deleted_at']:
    ...
    def list_installations(
        ...
        for installation in self._installations.values():
            ...
            if user_id is not None and team_id is not None:
                ...
                if installation['user_id'] == user_id or installation['team_id'] == team_id:
    ...
    def grant_access(
        ...
        for access in self._access_records.values():
            if (access['figma_installation_id'] == installation_id and
                access['user_id'] == user_id and
                access['deleted_at'] is None):
                raise ValueError(
    ...
    def create_attachment(
        ...
        for attachment in self._attachments.values():
            if (attachment['project_id'] == project_id and
                attachment['frame_url'] == frame_url and
    ...
    def list_attachments(
        ...
        for attachment in self._attachments.values():
            ...
            if tech_spec_id is not None and attachment['tech_spec_id'] != tech_spec_id:
                continue
    ...
    def get_all_installations(self, include_deleted: bool = False) -> List[Dict[str, Any]]:
        """
    ...
    def get_all_access_records(self, include_deleted: bool = False) -> List[Dict[str, Any]]:
        """
    ...
    def get_all_attachments(self, include_deleted: bool = False) -> List[Dict[str, Any]]:
        """
