...
Design Pattern (Dependency Injection):
    ...
    Production Usage (implicit defaults):
        ...
        >>> service = FigmaService()  # Uses default production repositories
        >>> installation = service.create_installation(user_id=1, name="My Figma", pat="figd_...")
    ...
    Test Usage (explicit fakes):
        ...
        >>> service = FigmaService(figma_repo=fake_figma_repo, secret_repo=fake_secret_repo)
        >>> # Service now uses in-memory fakes instead of real database/Secret Manager
...
# These are abstract base classes (ABCs) that define contracts for external system interactions
...
# These are production implementations that interact with actual external systems
...
# This __all__ list defines what gets imported when using "from repositories import *"
...
__all__ = [
    ...
    "IFigmaAPIRepository",
    "IConfigRepository",
    # Concrete Implementations (for production usage and default initialization)
    "FigmaRepository",
    "SecretRepository",
    "FigmaAPIRepository",
    "ConfigRepository",
